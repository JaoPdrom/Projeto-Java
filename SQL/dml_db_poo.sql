...
-- Table tb_cliente
-- -----------------------------------------------------
INSERT INTO tb_cliente (cli_id, cli_pes_documento, cli_dtCadastro)
VALUES
    (NULL, '00022255544', '2024-01-10'),
    (NULL, '11144477755', '2024-02-15'),
    (NULL, '88899955522', '2024-03-20'),
    (NULL, '88774411226', '2024-04-05');
...
-- Table tb_despesa
-- -----------------------------------------------------
-- Pressupõe que os IDs 1..6 existam em tb_tipoDespesa após o insert acima
INSERT INTO tb_despesa (despesa_id, despesa_descricao, despesa_dtRealizacao, despesa_valor, despesa_tipo_despesa_id)
VALUES
    (NULL, 'Aluguel galpão janeiro', '2025-01-05', 3500.00, 1),
    (NULL, 'Conta de energia janeiro', '2025-01-10', 820.45, 2),
    (NULL, 'Conta de água janeiro', '2025-01-12', 240.30, 3),
    (NULL, 'Combustível frota semana 01', '2025-01-15', 1200.00, 4),
    (NULL, 'Manutenção caminhão', '2025-01-18', 1850.75, 5),
    (NULL, 'Outras despesas administrativas', '2025-01-20', 560.00, 6);
...
-- Table tb_demissao
-- -----------------------------------------------------
-- Também referencia fnc_id existentes em tb_funcionario
INSERT INTO tb_demissao (demissao_id, demissao_data, demissao_motivo, demissao_fnc_id)
VALUES
    (NULL, '2020-01-01', 'Fim de contrato temporário', 1),
    (NULL, '2015-07-19', 'Redução de quadro',          4),
    (NULL, '2020-10-21', 'Pedido de demissão',         5),
    (NULL, '1970-02-02', 'Aposentadoria',              6);
SELECT * FROM tb_demissao;